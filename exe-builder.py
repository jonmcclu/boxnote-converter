...
# pyinstaller --windowed --add-data="/home/jonas/.local/share/virtualenvs/boxnote-converter-bKi7cG1s/lib/python3.8/site-packages/boxnotes2html:boxnotes2html" --onefile main-installer.py
